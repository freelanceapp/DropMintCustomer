 ...
 * itself to end up as a square. It also handles touches to be passed in to com.spinno.laundryapp.views that need to know
...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
    ...
    **/
    ...
    /**
     * When scroll forward/backward com.apporio.johnlaundry.events are received, jump the time to the higher/lower
