...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    public TimePickerDialog() {
        // Empty constructor required for dialog com.apporio.johnlaundry.fragment.
    }
    ...
    /**
     * For keyboard mode, processes key com.apporio.johnlaundry.events.
        ...
        if (mAmKeyCode == -1 || mPmKeyCode == -1) {
            ...
            for (int i = 0; i < Math.max(mAmText.length(), mPmText.length()); i++) {
                ...
                if (amChar != pmChar) {
                    ...
                    // There should be 4 com.apporio.johnlaundry.events: a down and up for both AM and PM.
