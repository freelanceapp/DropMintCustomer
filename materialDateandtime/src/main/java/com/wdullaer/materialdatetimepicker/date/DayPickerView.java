...
public abstract class DayPickerView extends ListView implements OnScrollListener,
     ...
     * to add custom com.apporio.johnlaundry.events when the title is changed.
     */
    ...
    /**
     * When scroll forward/backward com.apporio.johnlaundry.events are received, announce the newly scrolled-to month.
     */
    @SuppressLint("NewApi")
    @Override
