...
class LoginLogger {
    ...
    // prepend a column index to each name, and we log all columns with all com.apporio.johnlaundry.events, even if they are
    // empty.
    ...
    static Bundle newAuthorizationLoggingBundle(String authLoggerId) {
        // We want to log all parameters for all com.apporio.johnlaundry.events, to ensure stability of columns across
